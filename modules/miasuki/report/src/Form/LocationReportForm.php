 ...
 */
class LocationReportForm extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    foreach ($results as $each_order) {
      $order_address = OrderController::get_order_shipping_address_by_id($each_order->id);
      $location_data[$order_address['country_id']] = $location_data[$order_address['country_id']] + $each_order->grand_total;
    }
    $label_arr = array();
    $data_arr = array();
    $color_arr = array();
    $color_list = ReportController::report_color_list();
    foreach ($location_data as $each_location=>$each_sum) {
      $label_arr[] = $each_location;
      $data_arr[] = $each_sum;
    ...
    $form['chart']['#markup'] = new FormattableMarkup('<canvas id="location_report_chart" width="400" height="400"></canvas>', []);
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $url = Url::fromRoute('report.location_report_form', $query_parameter);
